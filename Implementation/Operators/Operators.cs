...
namespace ExprCore.Operators
{
    static class OperatorRegistry
    {
        ...
        public static void RegisterUnary(Type ret, Type operandType, char op, UnaryOperateFunc operation)
        {
            unary_operators.Add(new UnaryOperatorDef(ret, op, operandType), operation);
        }

        public static void RegisterBinary(Type ret, Type left, char op, Type right, BinaryOperateFunc operation)
        {
